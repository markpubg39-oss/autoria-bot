...
# Посилання на відеоінструкцію (YouTube), що додається в текст привітання /start
START_VIDEO_URL = os.getenv("START_VIDEO_URL", "https://youtu.be/dpC-usOPfnY")
...
async def start(msg: types.Message):
    ...
    await msg.answer(
        ...
        f"📺 Додаткова відеоінструкція тут: [{START_VIDEO_URL}]({START_VIDEO_URL})",
